export learn_susceptances, learn_susceptances_dates, learn_susceptances_dates1
...
function learn_susceptances_dates1(;
        model_file::String = MODULE_FOLDER * "/data/pantagruel.json",
        train_f_date::DateTime = DateTime(2021, 9, 16, 0),
        train_t_date::DateTime = DateTime(2021, 9, 17, 23),
        test_f_date::DateTime = DateTime(2021, 10, 17, 0),
        test_t_date::DateTime = DateTime(2021, 10, 17, 11),
        mesh_fn::String = MODULE_FOLDER * "/data/panta.msh",
        n_modes::Union{Nothing, Int} = nothing,
